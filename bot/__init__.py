...
try:
    ...
    START_BTN1_URL = 'https://t.me/arvinxoxo'
...
try:
    ...
    START_BTN2_NAME = 'Support Chat'
    START_BTN2_URL = 'https://t.me/arvinxoxo'
try:
...
try:
    ...
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/arvinxoxo'
except KeyError:
    AUTHOR_URL = 'https://t.me/arvinxoxo'
try:
    TITLE_NAME = getConfig('TITLE_NAME')
    if len(TITLE_NAME) == 0:
        TITLE_NAME = 'MirrorBot'
except KeyError:
    TITLE_NAME = 'MirrorBot'
